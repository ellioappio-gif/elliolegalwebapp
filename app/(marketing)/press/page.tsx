    ...
    <>
        ...
        <section className="hero">
          <div className="hero-container">
            <h1>Press & Media</h1>
            <p className="hero-highlight">News and updates about Ellio</p>
            <p>Latest press releases and media coverage.</p>
            <div className="hero-buttons">
              <Link href="/contact" className="btn-primary">Media Inquiries</Link>
            </div>
          </div>
        </section>
