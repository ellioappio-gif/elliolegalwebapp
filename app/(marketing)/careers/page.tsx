    ...
    <>
        ...
        <section className="hero">
          <div className="hero-container">
            ...
            <p className="hero-highlight">Democratizing legal access for everyone</p>
            <p>Help us build the future of legal technology.</p>
            <div className="hero-buttons">
              <Link href="/contact" className="btn-primary">View Open Positions</Link>
            </div>
          </div>
        </section>
