    ...
    <>
        ...
        <section className="hero">
          <div className="hero-container">
            ...
            <p className="hero-highlight">Real people, real results</p>
            <p>See how Ellio has helped thousands of users understand their legal documents.</p>
            <div className="hero-buttons">
              <Link href="/auth/signup" className="btn-primary">Join Them Today</Link>
            </div>
          </div>
        </section>
