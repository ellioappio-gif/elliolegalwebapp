      ...
      <section className="hero">
        <div className="container">
          <div className="hero-brand">
            <div className="highlight">How It Works</div>
          </div>
          <h1>Legal Help in Minutes,<br />Not Days</h1>
          <p className="hero-subtitle">Get legal help in minutes, not days. Here's exactly how our platform works.</p>
        </div>
      </section>
