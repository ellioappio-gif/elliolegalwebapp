  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-800">
      ...
      <section className="section">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary">Legal services market projected to reach $1 trillion by 2028</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3>$437B Market</h3>
              <p>US legal services market size in 2024, growing 4.2% annually</p>
            </div>
            <div className="card text-center">
              ...
              <h3>63% Unserved</h3>
              <p>Americans who can't afford legal representation for civil matters</p>
            </div>
            <div className="card text-center">
              ...
              <p>Average savings vs traditional attorney consultation</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6">Experience our product firsthand. Our AI can analyze contracts, answer legal questions, and connect users with qualified attorneys when needed.</p>
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Shield className="w-4 h-4 text-brand-indigo-600" />
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Document Analysis</h4>
                    <p className="text-text-secondary">Instant contract review and risk assessment</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Zap className="w-4 h-4 text-brand-indigo-600" />
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Instant Answers</h4>
                    <p className="text-text-secondary">24/7 AI legal guidance in plain English</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Users className="w-4 h-4 text-brand-indigo-600" />
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Attorney Matching</h4>
                    <p className="text-text-secondary">Connect with specialists when human expertise is needed</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-brand-indigo-50 to-brand-primary-100 rounded-2xl p-8">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-brand-indigo-100 rounded-full flex items-center justify-center">
                    <Zap className="w-5 h-5 text-brand-indigo-600" />
                  </div>
                  <div>
                ...
                <div className="space-y-3">
                  <div className="bg-gray-100 rounded-lg p-3 max-w-xs">
                    <p className="text-sm">I need help reviewing a rental agreement. Can you analyze it for any red flags?</p>
                  </div>
                  <div className="bg-brand-indigo-600 text-white rounded-lg p-3 ml-auto max-w-sm">
                    <p className="text-sm">I'd be happy to help! Please upload your rental agreement and I'll analyze it for potential issues like unfair clauses, deposit requirements, and tenant rights concerns.</p>
                  </div>
                  <div className="bg-gray-100 rounded-lg p-3 max-w-xs">
                    <p className="text-sm">📄 rental_agreement.pdf uploaded</p>
                  </div>
                  <div className="bg-brand-indigo-600 text-white rounded-lg p-3 ml-auto max-w-sm">
                    <p className="text-sm">✅ Analysis complete! I found 2 items that need attention: excessive late fees and unclear security deposit terms. Would you like a detailed breakdown?</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="traction" className="section">
        <div className="section-container">
          <div className="text-center mb-16">
            <h2>Early Traction & Validation</h2>
            <p className="text-xl text-text-secondary">Strong product-market fit signals</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-brand-indigo-600 mb-2">5,000+</div>
              <div className="text-text-secondary">Beta Users</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-brand-indigo-600 mb-2">94%</div>
              <div className="text-text-secondary">User Satisfaction</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-brand-indigo-600 mb-2">15K</div>
              <div className="text-text-secondary">Documents Analyzed</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-brand-indigo-600 mb-2">$50K</div>
              <div className="text-text-secondary">ARR Pipeline</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-alt">
        <div className="section-container">
          <div className="text-center mb-16">
            <h2>Scalable Revenue Model</h2>
            <p className="text-xl text-text-secondary">Multiple revenue streams with high margins</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="mb-4">Freemium model: $0, $29, $99, $299/month tiers with increasing AI capabilities and attorney access</p>
              <div className="text-2xl font-bold text-green-600">70% Gross Margin</div>
            </div>
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="mb-4">20% commission on attorney consultations booked through platform. $500K+ annual opportunity per attorney</p>
              <div className="text-2xl font-bold text-blue-600">20% Commission</div>
            </div>
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="mb-4">White-label solutions for law firms, insurance companies, and corporate legal departments</p>
              <div className="text-2xl font-bold text-purple-600">$50K+ ARR</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary">First-mover advantage in AI-powered consumer legal</p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-brand-indigo-50">
                  <tr>
                    <th className="px-6 py-4 text-left font-semibold">Feature</th>
                    <th className="px-6 py-4 text-center font-semibold text-brand-indigo-600">Ellio</th>
                    <th className="px-6 py-4 text-center font-semibold">LegalZoom</th>
                    <th className="px-6 py-4 text-center font-semibold">Rocket Lawyer</th>
                    <th className="px-6 py-4 text-center font-semibold">Traditional Firms</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    <td className="px-6 py-4 font-medium">AI Document Analysis</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-medium">24/7 Instant Answers</td>
                    <td className="px-6 py-4 text-center">✅</td>
                    <td className="px-6 py-4 text-center">❌</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-medium">Attorney Matching</td>
                    <td className="px-6 py-4 text-center">✅</td>
                    <td className="px-6 py-4 text-center">Limited</td>
                    <td className="px-6 py-4 text-center">✅</td>
                    <td className="px-6 py-4 text-center">❌</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-medium">Average Cost</td>
                    <td className="px-6 py-4 text-center text-green-600 font-semibold">$29/mo</td>
                    <td className="px-6 py-4 text-center">$99+</td>
                    <td className="px-6 py-4 text-center">$49+</td>
                    <td className="px-6 py-4 text-center text-red-600 font-semibold">$500/hr</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section id="contact" className="section-alt">
        <div className="section-container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary">Let's democratize legal access together</p>
          </div>
          <div className="max-w-4xl mx-auto">
              ...
              <div className="card">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">AI/Team/Marketing</span>
                  </div>
                </div>
                <Link href="mailto:investors@ellio.solutions?subject=Investment Inquiry" className="btn-primary w-full">
                  Request Pitch Deck
                </Link>
              </div>
              <div className="card">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center text-brand-indigo-600 font-semibold">1</div>
                    <span>Try our live product demo</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center text-brand-indigo-600 font-semibold">2</div>
                    <span>Review detailed pitch deck</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center text-brand-indigo-600 font-semibold">3</div>
                    <span>Schedule founder meeting</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-brand-primary-50 rounded-full flex items-center justify-center text-brand-indigo-600 font-semibold">4</div>
                    <span>Due diligence & term sheet</span>
                  </div>
                </div>
            ...
            <div className="text-center">
              <p className="text-text-secondary mb-4">Questions about our vision or investment opportunity?</p>
              <Link href="mailto:investors@ellio.solutions" className="text-brand-indigo-600 hover:text-brand-indigo-700 font-semibold">
                investors@ellio.solutions
              </Link>
            </div>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-section">
            <h4>Investors</h4>
            <Link href="/investor">Investment Opportunity</Link>
            <Link href="mailto:investors@ellio.solutions">Investor Relations</Link>
        ...
        <div className="footer-bottom">
          ...
          <div className="flex gap-4">
            <Link href="/investor" className="text-brand-indigo-600 hover:text-brand-indigo-700 font-semibold">
              Investor Relations
            </Link>
          </div>
        </div>
